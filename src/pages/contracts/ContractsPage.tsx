...
export default function ContractsPage() {
  ...
  const toPdfContract = (contract: ContractWithDetails) => {
    ...
    return {
      ...
      extra_discount_value: contract.extra_discount_value,
      extra_discount_months: contract.extra_discount_months,
      extra_discount_period_type: contract.extra_discount_period_type,
      extra_discount_end_date: contract.extra_discount_end_date,
      training_contact_name: contract.training_contact_name,
      training_contact_phone: contract.training_contact_phone,
