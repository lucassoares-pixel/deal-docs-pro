    ...
    <AppLayout>
      <div className="space-y-8">
        <PageHeader
          ...
          subtitle="Configure as faixas de comissão baseadas no atingimento de metas"
        />
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  A comissão é calculada sobre o valor de recorrência vendido, com base no percentual 
                  de atingimento da meta mensal do vendedor. Configure as faixas abaixo para definir 
                  os percentuais de premiação.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>Atingimento Mínimo</TableHead>
                    <TableHead>Atingimento Máximo</TableHead>
                    <TableHead>% de Prêmio</TableHead>
                          ...
                          <div className="flex items-center gap-2">
                            <Input
                              ...
                              onChange={(e) =>
                                setEditedValues({
                                  ...editedValues,
                                  max_percentage: Number(e.target.value),
                                })
                              }
                              className="w-24"
                            />
              ...
              {tiers?.map((tier) => (
                ...
                >
                  <p className="text-sm text-muted-foreground mb-1">
                    {tier.min_percentage}% – {tier.max_percentage}%
                  </p>
                  <p className="text-2xl font-bold text-primary">{tier.label}</p>
                  <p className="text-xs text-muted-foreground mt-1">de prêmio</p>
                </div>
              ))}
            </div>
          </CardContent>
